...
def build_conclusion(analysis):
    ...
    return {
        "title":"Заключение по результатам сравнительного анализа организационных документов",
        "introduction":[
...
def render_conclusion(analysis):
    ...
    return "<!doctype html><html lang='ru'><meta charset='utf-8'><title>Versa — заключение по результатам сопоставления</title><style>"+css+"</style><body>"+body+"</body></html>"
